...
// LSTAR
		...
		/**
		 * Fills a table with the "Table Filling Algorithm", suitable for finding the equivalent/distinct states,
		 * and for generating a witness between differnt dfa.
		 * The Table considered is only the upper triangular matrix, that can be saved in a linear array.
		 * @return A table saved in a linear array, with equivalent and different states.
		 */
