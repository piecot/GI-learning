...
gi::dfaEDSM::dfaEDSM(const int n_state, const int dim_alf, const string *alf, const int s_state)		// Constructor 1
...
gi::dfaEDSM::dfaEDSM(const int n_state, const int dim_alf, const string *alf)							// Default start state to 0
